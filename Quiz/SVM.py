...
for line in open('train_posi_tweets_2017.txt').readlines():
        ...
        pos_tweets = tweets1['text']
        f=open("Training Tweets.txt",'a')
        f.write("1,")
        f.write(pos_tweets)
        f.write("\n")
...
tweets = []
for line in open('Training Tweets.txt').readlines():
    items = line.split(',')
